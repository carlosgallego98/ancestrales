            ...
            <form action="{{ route('empleados.store') }}" id="empleados-form" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="fechaNacimientoInput" placeholder="dd/mm/yyyy" name="fecha_nacimiento" required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="selectGenero">Genero</label>
                        <select class="form-control" name="genero" name="selectGenero">
                            <option value="n">Selecciona un Género</option>
...
<script>
    $('#fechaNacimientoInput').inputmask('dd/mm/yyyy')
