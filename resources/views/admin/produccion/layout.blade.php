...
<head>
          ...
          <title>@yield('titulo','Panel de Administracion') | Area de Produccion</title>
      ...
      <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="{{route('produccion')}}" class="navbar-brand"><small>Producción</small> <b>Bebidas</b> Cristina Lozano</a>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
      ...
      <section class="content-header">
        <h1>
          @yield('titulo')
          <small>Area de Produccion</small>
        </h1>
      </section>
